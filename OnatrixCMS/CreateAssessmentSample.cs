...
namespace OnatrixCMS
{
    public class CreateAssessmentSample
    {
        ...
        public void createAssessment(string projectID = "onatrixcms-1727701819483", string recaptchaKey = "6LeDkVMqAAAAADstaNKx37xDreWoiF4biyfYPQgC", string token = "action-token", string recaptchaAction = "action-name")
        {
